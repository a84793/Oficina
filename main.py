from clientes import nova_ficha_de_cliente, nova_ficha_de_cliente
...
from veiculos import cria_novo_Perfil_de_utilizador, imprime_lista_de_veiculos
...
def menu():
    ...
    while True:
        print("""
        *********************************************************************
        :    (-: OFICINA DO ESTEVES - RESISTIMOS A QUALQUER ORÇAMENTO :-)    :
        *********************************************************************
        :                                                                   :
